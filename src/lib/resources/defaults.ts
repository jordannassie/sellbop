...
export const INTEGRATIONS: Record<string, IntegrationMeta> = {
  claude: {
    ...
    steps_title: 'How to Connect Claude',
    steps: [
      'Open SellBop → Settings → AI & Integrations',
      'Create a Claude connection and copy your SellBop token',
      'Open Claude on your computer or phone',
      'Go to Customize → Connectors',
      'Add SellBop as a remote connector',
      'Paste your SellBop MCP URL and token when prompted',
      'Authorize your SellBop account when prompted',
      'Start asking Claude to create products for your store',
    ],
