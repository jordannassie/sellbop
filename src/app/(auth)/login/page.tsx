...
function AuthForm() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      if (mode === 'login') {
        ...
        router.push(session.role === 'buyer' ? '/purchases' : '/dashboard')
      } else {
  ...
  function handleGoogle() {
    toast.info('Google login coming soon — use email below for now.', { duration: 3000 })
  }
      ...
      <div className="bg-white border border-neutral-200 rounded-2xl shadow-sm overflow-hidden">
        ...
        <div className="p-7">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 border border-neutral-200 rounded-xl py-2.5 text-sm font-medium text-neutral-700 hover:bg-neutral-50 hover:border-neutral-300 transition-colors"
          >
            <GoogleIcon />
          ...
          {/* Demo hint */}
          <div className="mb-4 px-3 py-2.5 bg-neutral-50 border border-neutral-200 rounded-lg text-xs text-neutral-600">
            {mode === 'login'
              ? <><strong>Demo:</strong> creator@sellbop.demo / demo123</>
...
export default function LoginPage() {
  return (
    <Suspense fallback={<div className="w-full max-w-sm h-96 bg-white rounded-2xl border border-neutral-200 animate-pulse" />}>
      <AuthForm />
    </Suspense>
  )
}
