...
// POST /api/orders/[id]/refund — initiate a refund (Stripe placeholder)
export async function POST(
  ...
  // ── STRIPE REFUND INTEGRATION POINT ─────────────────────────────────────────
  // TODO: Activate when Stripe is connected.
  //
  ...
  // })
  //
  // Then update order: payment_status = 'refunded', refund_status = 'refunded'
  // And revoke purchase entitlement.
  // ────────────────────────────────────────────────────────────────────────────
