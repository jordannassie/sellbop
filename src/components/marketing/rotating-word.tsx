...
const WORDS = [
  { text: 'templates',     gradient: 'from-blue-500 via-indigo-500 to-purple-600' },
  { text: 'coaching',      gradient: 'from-orange-400 via-pink-500 to-rose-500' },
  { text: 'downloads',     gradient: 'from-emerald-400 via-cyan-500 to-teal-500' },
  ...
  { text: 'media packs',   gradient: 'from-cyan-400 via-blue-500 to-violet-600' },
]
