-- =============================================================================
-- APPLY MIGRATION 033 — SellBop Production
-- =============================================================================
--
...
--
-- WHAT THIS ADDS:
--   • creative_generation_usage table — tracks AI image/PDF generation usage
--
-- RUN THIS AFTER migration 032 (APPLY-032-IN-SUPABASE.sql) has succeeded.
--
-- HOW TO RUN:
...
-- DESTRUCTIVE: No — only creates a new table and indexes
--
-- =============================================================================
