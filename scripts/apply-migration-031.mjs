#!/usr/bin/env node
/**
 * Apply migration 031_partner_financials.sql
 *
 * Usage:
 *   npm run db:apply-031
 */
...
const migrationFile = '031_partner_financials.sql'
...
if (!databaseUrl) {
  ...
  console.error('Set it in the environment or in .env.local, then run: npm run db:apply-031')
  process.exit(1)
}
