#!/usr/bin/env node
/**
 * Apply migration 030_partner_shops.sql
 *
 * Usage:
...
const migrationFile = '030_partner_shops.sql'
...
if (!databaseUrl) {
  ...
  console.error('Set it in the environment or in .env.local, then run: npm run db:apply-030')
  process.exit(1)
}
